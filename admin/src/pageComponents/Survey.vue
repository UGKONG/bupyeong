  ...
  <section>
    <section class="main">
      <table border="1">
        ...
        <tbody>
          <surveyList v-for="(item, idx) in surveyList"
...
export default {
  components: {
    addSurveyModal: () => import('../pageSubComponents/Survey/addSurveyModal'),
    surveyList: () => import('../pageSubComponents/Survey/surveyList'),
  },
  props: {
    sendData: Object,
